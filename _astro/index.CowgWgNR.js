import{s as p,g as u}from"./_astro_assets.B92FZ0gI.js";import{c as l,r as e,m as s,u as y}from"./hoisted.DR1ji9cg.js";import"./astro/assets-service.DxDlkXph.js";import"./_commonjsHelpers.C4iS2aBk.js";import"./hoisted.33BSnmmm.js";const v={src:"/_astro/waterfall-model.DUrZeeC6.png",width:767,height:516,format:"png"},d={src:"/_astro/v-model.C8s062YE.png",width:827,height:637,format:"png"},k=async function(i){const n={};{const g=new RegExp('__ASTRO_IMAGE_="([^"]*src/assets/media/post/waterfall-model\\.png[^"]*)"',"g");let c,h=0;for(;(c=g.exec(i))!==null;){const t="src/assets/media/post/waterfall-model.png_"+h,m=JSON.parse(c[1].replace(/&#x22;/g,'"')),{src:o,...a}=m;n[t]=await u({src:v,...a}),h++}}{const g=new RegExp('__ASTRO_IMAGE_="([^"]*src/assets/media/post/v-model\\.png[^"]*)"',"g");let c,h=0;for(;(c=g.exec(i))!==null;){const t="src/assets/media/post/v-model.png_"+h,m=JSON.parse(c[1].replace(/&#x22;/g,'"')),{src:o,...a}=m;n[t]=await u({src:d,...a}),h++}}return n};async function x(i){return k(i).then(n=>i.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(g,c)=>{const h=JSON.parse(c.replace(/&#x22;/g,'"')),t=h.src+"_"+h.index;n[t].srcSet&&n[t].srcSet.values.length>0&&(n[t].attributes.srcset=n[t].srcSet.attribute);const{index:m,...o}=n[t].attributes;return p({src:n[t].src,...o})}))}const r=await x(`<p>Mô hình phát triển phần mềm là thể hiện trừu tượng của các tiến trình phát triển phần mềm. Nó xác định các pha/ giai đoạn trong phát triển phần mềm.</p>
...
<img __ASTRO_IMAGE_="{&#x22;src&#x22;:&#x22;src/assets/media/post/waterfall-model.png&#x22;,&#x22;alt&#x22;:&#x22;Mô hình thác nước&#x22;,&#x22;index&#x22;:0}">
<h3 id="a-đặc-điểm">a. Đặc điểm</h3>
...
<h4 id="các-giai-đoạn-tuần-tự-trong-mô-hình-thác-nước">Các giai đoạn tuần tự trong mô hình thác nước</h4>
<ul>
...
<h3 id="b-ưu-nhược-điểm">b. Ưu, nhược điểm</h3>
...
<h2 id="2-mô-hình-chữ-v">2. Mô hình chữ V</h2>
...
<img __ASTRO_IMAGE_="{&#x22;src&#x22;:&#x22;src/assets/media/post/v-model.png&#x22;,&#x22;alt&#x22;:&#x22;Mô hình chữ V&#x22;,&#x22;index&#x22;:0}">
<h3 id="a-đặc-điểm-1">a. Đặc điểm</h3>
...
<h3 id="b-ưu-nhược-điểm-1">b. Ưu, nhược điểm</h3>
...
<h3 id="a-đặc-điểm-2">a. Đặc điểm</h3>
...
<h3 id="b-ưu-nhược-điểm-2">b. Ưu, nhược điểm</h3>
...
<!-- ![Mô hình xoắn ốc](src/assets/media/post/xoan-oc.png) -->
<h3 id="a-đặc-điểm-3">a. Đặc điểm</h3>
...
<h4 id="các-giai-đoạn-trong-phát-triển-phần-mềm-theo-mô-hình-xoắn-ốc">Các giai đoạn trong phát triển phần mềm theo mô hình xoắn ốc</h4>
<ul>
...
<h3 id="b-ưu-nhược-điểm-3">b. Ưu, nhược điểm</h3>
...
<p>Mô hình đóng vai trò là hướng đi và quyết định đến chất lượng đầu ra của sản phẩm. Vì vậy, việc xác định đúng và chính xác mô hình cho phần mềm là rất quan trọng. Mỗi mô hình quy trình tuân theo một loạt các bước duy nhất đối với loại của nó để đảm bảo thành công trong quy trình phát triển phần mềm. Tùy vào cấu trúc phần mềm mà từ đó chọn đúng mô hình phần mềm để thực hiện. Trong thực tế, chúng ta không nhất thiết phải sử dụng đúng các mô hình phần mềm trên mà có thể “biến tấu”, thay đổi để phù hợp với dự án phần mềm.</p>`),b={title:"Một số mô hình phát triển phần mềm (Phần 1)",publishDate:"2023-03-05T08:00:00.000Z",description:"Mô hình phát triển phần mềm là thể hiện trừu tượng của các tiến trình phát triển phần mềm. Nó xác định các pha/ giai đoạn trong phát triển phần mềm.",tags:["Software"],coverImage:{src:"src/assets/media/feature/Software-Development-Life-Cycle.png",color:"#64574D"},language:"Vietnamese",minutesRead:"15 min read"},q="/home/runner/work/zhaospei.github.io/zhaospei.github.io/src/content/post/software-models-chapter-1/index.md",M=void 0;function _(){return`
...
## Kết luận
Mô hình đóng vai trò là hướng đi và quyết định đến chất lượng đầu ra của sản phẩm. Vì vậy, việc xác định đúng và chính xác mô hình cho phần mềm là rất quan trọng. Mỗi mô hình quy trình tuân theo một loạt các bước duy nhất đối với loại của nó để đảm bảo thành công trong quy trình phát triển phần mềm. Tùy vào cấu trúc phần mềm mà từ đó chọn đúng mô hình phần mềm để thực hiện. Trong thực tế, chúng ta không nhất thiết phải sử dụng đúng các mô hình phần mềm trên mà có thể "biến tấu", thay đổi để phù hợp với dự án phần mềm.`}function S(){return r}function w(){return[{depth:2,slug:"1-mô-hình-thác-nước",text:"1. Mô hình thác nước"},{depth:3,slug:"a-đặc-điểm",text:"a. Đặc điểm"},{depth:4,slug:"các-giai-đoạn-tuần-tự-trong-mô-hình-thác-nước",text:"Các giai đoạn tuần tự trong mô hình thác nước"},{depth:3,slug:"b-ưu-nhược-điểm",text:"b. Ưu, nhược điểm"},{depth:2,slug:"2-mô-hình-chữ-v",text:"2. Mô hình chữ V"},{depth:3,slug:"a-đặc-điểm-1",text:"a. Đặc điểm"},{depth:3,slug:"b-ưu-nhược-điểm-1",text:"b. Ưu, nhược điểm"},{depth:2,slug:"3-bản-mẫu",text:"3. Bản mẫu"},{depth:3,slug:"a-đặc-điểm-2",text:"a. Đặc điểm"},{depth:3,slug:"b-ưu-nhược-điểm-2",text:"b. Ưu, nhược điểm"},{depth:2,slug:"4-xoắn-ốc",text:"4. Xoắn ốc"},{depth:3,slug:"a-đặc-điểm-3",text:"a. Đặc điểm"},{depth:4,slug:"các-giai-đoạn-trong-phát-triển-phần-mềm-theo-mô-hình-xoắn-ốc",text:"Các giai đoạn trong phát triển phần mềm theo mô hình xoắn ốc"},{depth:3,slug:"b-ưu-nhược-điểm-3",text:"b. Ưu, nhược điểm"},{depth:2,slug:"kết-luận",text:"Kết luận"}]}const D=l((i,n,g)=>{const{layout:c,...h}=b;return h.file=q,h.url=M,e`${s()}${y(r)}`});export{D as Content,S as compiledContent,D as default,q as file,b as frontmatter,w as getHeadings,_ as rawContent,M as url};
