import{c as h,r as i,m as c,u as a}from"./hoisted.BH1iQ6Yg.js";import"./astro/assets-service.DxDlkXph.js";import"./_commonjsHelpers.C4iS2aBk.js";import"./hoisted.33BSnmmm.js";const t=`<p>Chào!
...
<p>Về giao diện của blog, tớ lấy cảm hứng từ <a href="https://reaganhenke.com/" rel="nofollow, noopener, noreferrer" target="_blank">Reaganhenke</a> và <a href="https://www.digitalocean.com/" rel="nofollow, noopener, noreferrer" target="_blank">Digital Ocean</a>.</p>
<p>Tớ biết đến <a href="https://reaganhenke.com/" rel="nofollow, noopener, noreferrer" target="_blank">Reaganhenke</a> nhờ vào một hôm tìm cái trang web nghe nhạc lofi để học. Sau khi tìm hiểu, tớ có biết đến <a href="https://imissmycafe.com/" rel="nofollow, noopener, noreferrer" target="_blank">I Miss My Cafe</a>. Đây là một trang đối với tớ khá là hay, recommend cậu trang này nhé!(à cậu có thể vào để tìm hiểu về nó nhé :))). Tính tớ hay tò mò nên tớ đã lục lọi để tìm ra source của nó để clone lại một trang giống như vậy :)). Kết quả là tớ chỉ tìm được page của người làm ra nó. Và rồi, tớ bị thu hút bởi thiết kế của page, nhất là mấy cái card đầu của page. Haha, và rồi tớ lấy nó để làm giao diện.
<em>(Reagan Henke, if you see this blog, please forgive me for using it without your permission!)</em>.</p>
<p>Còn <a href="https://www.digitalocean.com/" rel="nofollow, noopener, noreferrer" target="_blank">Digital Ocean</a> thì một lần tớ tìm tutorial và tìm ra nó. Đây cũng một trang chất lượng, recommend cậu trang này nữa nhé! (À thực ra ai cũng biết đến trang này :))).</p>
<p>Ngoài ra tớ còn sử dụng <a href="https://vincentgarreau.com/particles.js/" rel="nofollow, noopener, noreferrer" target="_blank">particles.js</a> để làm mấy cái lines nối nhau trông rườm rà ở background và <a href="https://talk.hyvor.com/" rel="nofollow, noopener, noreferrer" target="_blank">Hyvor</a> để làm phần comment (Tớ chỉ được dùng thử 15 ngày nên không biết 15 ngày sau nó có bị mất không :))).</p>
...
<p>Cậu có thể xem source code của blog tớ tại <a href="https://github.com/zhaospei/zhaospei.github.io" rel="nofollow, noopener, noreferrer" target="_blank">Github</a>.</p>
...
<div style="text-align: right"> 
<strong>Zhao</strong>
</div>`,g={title:"Welcome to the new world!",publishDate:"2023-02-22T08:00:00.000Z",description:"The first post in the world",tags:["Talk"],coverImage:{src:"src/assets/media/feature/about-this-blog.jpg",color:"#2f4036"},language:"Vietnamese",minutesRead:"4 min read"},o="/home/runner/work/zhaospei.github.io/zhaospei.github.io/src/content/post/about-this-blog/index.md",e=void 0;function y(){return`
Chào!
Hmm, đầu tiên phải giới thiệu đôi chút về bản thân nhỉ? À chắc không cần, vì mấy cái câu giới thiệu bản thân tớ 
...
`}function d(){return t}function k(){return[{depth:2,slug:"tại-sao-tớ-lại-xây-dựng-cái-blog-này",text:"Tại sao tớ lại xây dựng cái blog này?"},{depth:2,slug:"cách-tớ-thực-hiện-cái-blog-này",text:"Cách tớ thực hiện cái blog này…"},{depth:2,slug:"mục-đích-hướng-đến-của-blog",text:"Mục đích hướng đến của blog…"},{depth:2,slug:"mong-muốn-của-tớ",text:"Mong muốn của tớ…"}]}const f=h((r,l,m)=>{const{layout:s,...n}=g;return n.file=o,n.url=e,i`${c()}${a(t)}`});export{f as Content,d as compiledContent,f as default,o as file,g as frontmatter,k as getHeadings,y as rawContent,e as url};
